      ...
      <Card variant="flat" css={{ marginBottom: "$10" }}>
        <Card.Body css={{ backgroundColor: "$accents2" }}>
          <Text css={{ fontFamily: "inherit", textAlign: "center" }} as={"p"}>
            Hello, I&apos;m Vishisht Kapoor. I&apos;m a Devloper based in
            India!
          </Text>
        </Card.Body>
      </Card>
          ...
          <Box as={"ul"} css={{ m: 0 }}>
            <Box as={"li"}>
              <Link
                ...
                target={"_blank"}
                color="primary"
                href="https://github.com/vishishtkapoor"
              >
                <Button
                  light
                  color="primary"
            ...
            <Box as={"li"}>
              <Link
                ...
                target={"_blank"}
                color="primary"
                href="https://www.linkedin.com/in/vishishtkapoor"
              >
                <Button
                  light
                  color="primary"
